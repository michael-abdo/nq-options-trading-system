...
(async () => {
    ...
    try {
        ...
        const url = 'https://www.barchart.com/futures/quotes/NQU25/options/MM3N5?futuresOptionsView=merged';
        ...
        const result = {
            ...
            days_to_expiry: null,
            raw_text: null,
            url: 'https://www.barchart.com/futures/quotes/NQU25/options/MM3N5?futuresOptionsView=merged',
            success: false,
            match: false,
            error: error.message
        };
