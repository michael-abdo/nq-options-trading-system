...
def test_historical_backtester():
    ...
    from historical_backtester import create_backtester, BacktestConfig
...
def test_cost_analyzer():
    ...
    from cost_analyzer import create_cost_analyzer, DataProvider
...
def test_all_integrations():
    ...
    from cost_analyzer import create_cost_analyzer
    ...
    from paper_trading_executor import run_paper_trading_comparison
